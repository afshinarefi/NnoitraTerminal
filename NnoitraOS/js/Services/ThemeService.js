...
class ThemeService extends BaseService{
    ...
    async start() {
        ...
        const { value } = await this.request(EVENTS.VAR_GET_REQUEST, { key: VAR_THEME, category: 'SYSTEM' });
    ...
    #handleUpdateDefaultRequest({ key, respond }) {
        if (key === VAR_THEME) {
            this.dispatch(EVENTS.VAR_SET_REQUEST, { key, value: DEFAULT_THEME, category: 'SYSTEM' });
    ...
    applyTheme(themeName) {
        ...
        this.dispatch(EVENTS.VAR_SET_REQUEST, { key: VAR_THEME, value: finalTheme, category: 'SYSTEM' });
